/**
 * Unitinder — 20-question student questionnaire.
...
const QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      { label: 'A', text: '"Solo — every time, no exceptions"', dimensions: { social_preference: 0.0, autonomy: 0.9 } },
...
module.exports = { DIMENSION_KEYS, QUESTIONS };
